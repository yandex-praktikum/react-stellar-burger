      ...
      <div className={styles.container}>
        ...
        <div className={`${styles.info} text text_type_main-default pb-15`}>
          ...
          <div className={styles.item}>
            ...
            <p className="text text_type_digits-default text_color_inactive ml-2">{el.proteins}</p>
          </div>
          <div className={styles.item}>
            <p className="text text_type_main-default text_color_inactive">Жиры,г</p>
            <p className="text text_type_digits-default text_color_inactive ml-2">{el.fat}</p>
          </div>
          <div className={styles.item}>
            <p className="text text_type_main-default text_color_inactive">Углеводы,г</p>
            <p className="text text_type_digits-default text_color_inactive ml-2">{el.carbohydrates}</p>
          </div>
        </div>
      </div>
    </div>
